...
export class UpdatePreferencesHandler
  implements BaseCommandHandler<UpdatePreferencesCommand, UserResponseDto>, ICommandHandler<UpdatePreferencesCommand>
{
  constructor(@Inject('IUserRepository') private readonly repository: IUserRepository) {}

  async execute(command: UpdatePreferencesCommand): Promise<UserResponseDto> {
