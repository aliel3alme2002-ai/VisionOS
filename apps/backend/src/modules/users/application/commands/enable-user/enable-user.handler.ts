...
export class EnableUserHandler
  implements BaseCommandHandler<EnableUserCommand, UserResponseDto>, ICommandHandler<EnableUserCommand>
{
  constructor(@Inject('IUserRepository') private readonly repository: IUserRepository) {}

  async execute(command: EnableUserCommand): Promise<UserResponseDto> {
