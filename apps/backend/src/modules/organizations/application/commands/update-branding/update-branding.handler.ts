...
export class UpdateBrandingHandler
  implements BaseCommandHandler<UpdateBrandingCommand, OrganizationResponseDto>, ICommandHandler<UpdateBrandingCommand>
{
  constructor(
